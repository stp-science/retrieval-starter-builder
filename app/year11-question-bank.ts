...
const year11TopicCandidates: Year11Topic[] = [
  ...
  makeTopic({
    ...
    concepts: [
      ...
      ["physical barrier", "What first-line defence blocks pathogens from entering the body?", "What type of defence includes skin, mucus and cilia?", "How do mucus and cilia protect the respiratory system?", "Mucus traps microorganisms and cilia move the mucus toward the throat to be swallowed or expelled.", "foundation"],
