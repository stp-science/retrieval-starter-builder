...
export const year11PhysicsTopics: Year11PhysicsTopic[] = [
  makePhysicsTopic({
    ...
    concepts: [
      ...
      ["velocity", "What quantity equals displacement divided by time?", "In v = Δx/Δt, what does v represent?", "A runner moves 100 m north in 12.5 s. Calculate the average velocity.", "v = 100 ÷ 12.5 = 8.0 m/s north.", "core"],
      ["acceleration", "What quantity equals change in velocity divided by time?", "In a = Δv/Δt, what does a represent?", "A car speeds up from 5 m/s to 25 m/s in 4 s. Calculate its acceleration.", "a = (25 - 5) ÷ 4 = 5 m/s².", "core"],
      ["distance-time gradient", "What part of a distance-time graph shows speed?", "What do you calculate on a distance-time graph to find the speed?", "A distance-time line rises 40 m in 8 s. What speed does its gradient show?", "The speed is 40 ÷ 8 = 5 m/s.", "core"],
      ["velocity-time area", "What part of a velocity-time graph gives the displacement?", "What do you calculate on a velocity-time graph to find the distance travelled when the velocity stays positive?", "A velocity-time graph shows 10 m/s for 6 s. Calculate the distance travelled.", "The rectangular area is 10 × 6 = 60 m.", "core"],
      ["contact force", "What type of force acts only when objects or materials touch?", "What type of force includes normal force, tension and compression?", "Why is the support force from a table a contact force?", "It arises from direct interaction between the touching table and object.", "core"],
      ["field force", "What type of force can act without physical contact?", "What type of force includes gravity and electrostatic force?", "How can Earth pull a falling object without touching it?", "The object is in Earth's gravitational field, which exerts a force on its mass.", "core"],
      ...
      ["balanced forces", "What term describes forces that combine to give zero net force?", "Which force condition produces no acceleration?", "State what an object can do when its forces are balanced.", "It can remain at rest or move at constant velocity because its acceleration is zero.", "core"],
      ...
      ["weight", "In W = mg, what does W represent?", "Which force is measured in newtons and depends on gravitational field strength?", "Calculate the weight of a 6 kg bag where g = 9.8 N/kg.", "W = mg = 6 × 9.8 = 58.8 N.", "core"],
      ["work done", "In W = Fd, what does W represent?", "Which quantity equals force multiplied by distance moved in the force direction?", "A 30 N force pushes a box 4 m. Calculate the work done.", "W = Fd = 30 × 4 = 120 J.", "core"],
      ["kinetic energy", "In Ek = ½mv², what does Ek represent?", "Which energy increases with the square of speed?", "Calculate the kinetic energy of a 2 kg ball moving at 6 m/s.", "Ek = ½ × 2 × 6² = 36 J.", "core"],
      ["gravitational potential energy", "In Ep = mgh, what does Ep represent?", "Which energy increases when a mass is raised in a gravitational field?", "A 3 kg book is lifted 2 m where g = 9.8 N/kg. Calculate the energy gained.", "Ep = mgh = 3 × 9.8 × 2 = 58.8 J.", "core"],
      ...
      ["power", "In P = E/t, what does P represent?", "Which quantity is measured in watts?", "A motor transfers 600 J in 5 s. Calculate its power.", "P = E/t = 600 ÷ 5 = 120 W.", "core"],
      ...
      ["momentum", "In p = mv, what does p represent?", "Which motion quantity has the unit kg·m/s?", "Calculate the momentum of a 0.15 kg ball moving at 20 m/s.", "p = mv = 0.15 × 20 = 3 kg·m/s.", "core"],
  ...
  makePhysicsTopic({
    ...
    concepts: [
      ...
      ["neutral object", "What do we call an object with equal amounts of positive and negative charge?", "What do we call an object with no overall charge?", "How can a neutral object still contain charged particles?", "Its positive and negative charges are equal overall, so they cancel to give zero net charge.", "foundation"],
      ["positive charge", "What is the overall charge of an object that has lost electrons?", "If an object has fewer electrons than protons, what is its overall charge?", "How does an initially neutral object become positively charged?", "Electrons leave the object, leaving more positive proton charge than negative electron charge.", "core"],
      ["negative charge", "What is the overall charge of an object that has gained electrons?", "If an object has more electrons than protons, what is its overall charge?", "How does an initially neutral object become negatively charged?", "It gains electrons, giving it more negative than positive charge.", "core"],
      ["charge interaction", "What do we call the rule that like charges repel and opposite charges attract?", "What rule tells us whether two charged objects will attract or repel?", "What happens when two negatively charged objects are brought close together?", "They repel because like charges exert forces away from each other.", "core"],
      ...
      ["electric circuit", "What complete conducting path allows charge to flow?", "What do we call a source, wires and components connected in a closed loop?", "Why does opening a switch stop current?", "It breaks the conducting path, so charge can no longer circulate around the circuit.", "foundation"],
      ["circuit symbol", "What standard symbol represents an electrical component in a circuit diagram?", "Which agreed notation is used to draw clear circuit diagrams?", "Why are standard circuit symbols useful?", "They communicate component types and connections clearly without drawing realistic pictures.", "core"],
      ...
      ["resistance", "What opposition to current is measured in ohms?", "In R = V/I, what does R represent?", "How does increasing resistance affect current at constant voltage?", "Current decreases because I = V/R.", "core"],
      ...
      ["series circuit", "Which type of circuit has only one path for the current?", "Which type of circuit has components connected one after another in a single loop?", "What happens to total resistance when another resistor is added in series?", "Total resistance increases because series resistances add.", "core"],
      ["parallel circuit", "Which type of circuit has two or more paths for the current?", "Which type of circuit lets other home lights stay on when one light is switched off?", "Why does adding a parallel branch reduce total resistance?", "It provides another path for charge, so more total current flows at the same supply voltage.", "core"],
      ["series resistance", "In RT = R1 + R2 + R3 + ..., what does RT represent?", "Which circuit quantity is found by adding all resistor values in series?", "Calculate the total resistance of 2 Ω, 3 Ω and 5 Ω resistors in series.", "RT = 2 + 3 + 5 = 10 Ω.", "core"],
      ...
      ["electrical power", "In P = IV, what does P represent?", "Which quantity links circuit current and voltage to brightness or heating?", "A bulb uses 3 A from a 12 V supply. Calculate its power.", "P = IV = 3 × 12 = 36 W.", "core"],
      ...
      ["electromagnetic device", "What device uses a controlled electromagnet to produce an action?", "What type of device includes electric bells, magnetic locks and scrapyard cranes?", "How does an electromagnetic lock release?", "Switching off current removes the electromagnet's field, so the magnetic holding force falls away.", "stretch"],
    ],
  }),
  makePhysicsTopic({
    ...
    concepts: [
      ...
      ["mechanical wave", "What type of wave needs a medium to travel through?", "What type of wave includes sound waves and water waves?", "Why can a mechanical wave not cross a vacuum?", "It relies on particles or parts of a medium interacting to pass on the oscillation.", "core"],
      ["electromagnetic wave", "What wave consists of oscillating electric and magnetic fields?", "What type of wave can travel through a vacuum?", "How does an electromagnetic wave differ from a mechanical wave?", "It does not require a material medium because oscillating electric and magnetic fields sustain one another.", "core"],
      ...
      ["wave speed", "In v = fλ, what does v represent?", "Which speed describes how fast a wave disturbance travels?", "A wave has frequency 50 Hz and wavelength 6 m. Calculate its speed.", "v = fλ = 50 × 6 = 300 m/s.", "core"],
      ...
      ["total internal reflection", "What complete reflection occurs inside a higher-index material?", "Which behaviour keeps light travelling along an optical fibre?", "State the two conditions required for total internal reflection.", "Light must travel from higher to lower refractive index and strike the boundary above the critical angle.", "core"],
  ...
  makePhysicsTopic({
    ...
    concepts: [
      ...
      ["temperature", "What is the measure of the average kinetic energy of particles called?", "Which thermal quantity rises when particles move faster on average?", "How is temperature different from internal energy?", "Temperature tracks average kinetic energy, while internal energy is the total kinetic and potential energy of all particles.", "core"],
      ...
      ["conduction", "Name the method of thermal energy transfer through a solid.", "Which method transfers thermal energy through a metal?", "How does the kinetic model explain conduction through a solid?", "Hotter particles vibrate more and transfer energy to neighbours through interactions; mobile electrons also transfer energy in metals.", "core"],
      ["convection", "Name the method of thermal energy transfer caused by movement within a liquid or gas.", "Which process forms circulating currents in liquids and gases?", "How does heating create a convection current?", "Warmer fluid expands and becomes less dense, rises, and is replaced by cooler denser fluid.", "core"],
      ["thermal radiation", "Name the method of thermal energy transfer by electromagnetic waves.", "Which method can transfer thermal energy through a vacuum?", "Why does a shiny lining reduce energy loss from a vacuum flask?", "Shiny surfaces are poor emitters and good reflectors of infrared radiation.", "core"],
      ["specific heat capacity", "Name the thermal property that gives the energy needed to raise 1 kg of a substance by 1 °C.", "Which material property appears in Q = mcΔT?", "Calculate the energy needed to heat 2 kg of water with c = 4180 J/kg°C by 10 °C.", "Q = mcΔT = 2 × 4180 × 10 = 83,600 J.", "core"],
      ["thermal equilibrium", "What state is reached when objects share one temperature and net heat transfer stops?", "Which final condition is reached after hot and cold substances are mixed?", "Equal masses of the same liquid at 80 °C and 20 °C are mixed with no energy losses. Calculate the final temperature.", "The final temperature is halfway between them: 50 °C.", "core"],
      ["specific latent heat", "Name the thermal property that gives the energy needed to change the state of 1 kg without changing its temperature.", "Which material property appears in Q = mL?", "Calculate the energy needed to melt 0.5 kg of ice when L = 334,000 J/kg.", "Q = mL = 0.5 × 334,000 = 167,000 J.", "core"],
