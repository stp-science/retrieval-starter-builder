...
export const year10Topics: Year10Topic[] = [
  ...
  makeTopic({
    ...
    concepts: [
      ...
      ["weight", "What gravitational force acts on a mass?", "In W = mg, what does W represent?", "Weight depends on mass and gravitational field strength and acts toward the attracting body's centre.", "core"],
  ...
  makeTopic({
    ...
    concepts: [
      ...
      ["resistance", "What opposition to current is measured in ohms?", "In R = V/I, what does R represent?", "Resistance limits current and causes electrical energy to transfer to other stores.", "core"],
      ...
      ["electrical power", "In P = IV, what does P represent?", "Which circuit quantity is measured in watts?", "Electrical power states how much energy a component transfers each second.", "core"],
